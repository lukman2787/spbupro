    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="<?= base_url() ?>/assets/index3.html" class="brand-link">
                <img src="<?= base_url() ?>/assets/dist/img/spbupro_logo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
                <span class="brand-text font-weight-light">Media</span>
            </a>
        ...
        <footer class="main-footer">
            <strong>Copyright &copy; 2020-2021 <a href="#">CMS SPBU Pro</a>.</strong>
            All rights reserved.
