...
<body>
    ...
    <section id="main-slider" class="no-margin">
        <div class="carousel slide">
            <div class="carousel-inner">
                <div class="item active" style="background-image: url(<?= base_url() ?>/frontend/images/slider/bg1.jpg)">
                    <div class="container">
                        <div class="row slide-margin">
                            <div class="col-sm-6">
                                <div class="carousel-content">
                                    ...
                                    <a class="btn-slide animation animated-item-3" href="<?= base_url() ?>/frontend/#">Read More</a>
                                </div>
                            </div>

                            <div class="col-sm-6 hidden-xs animation animated-item-4">
                                <div class="slider-img">
                                    <img src="<?= base_url() ?>/frontend/images/slider/img3.png" class="img-responsive">
                                </div>
                            </div>
    ...
    <div class="about">
        <div class="container">
            <div class="col-md-6 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms">
                <h2>about us</h2>
                <img src="<?= base_url() ?>/frontend/images/6.jpg" class="img-responsive" />
    ...
    <div class="lates">
        <div class="container">
            ...
            <div class="col-md-4 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms">
                <img src="<?= base_url() ?>/frontend/images/4.jpg" class="img-responsive" />
    ...
    <section id="partner">
        <div class="container">
            ...
            <div class="partners">
                <ul>
                    <li> <a href="<?= base_url() ?>/frontend/#"><img class="img-responsive wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms" src="<?= base_url() ?>/frontend/images/partners/partner1.png"></a></li>
                    <li> <a href="<?= base_url() ?>/frontend/#"><img class="img-responsive wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms" src="<?= base_url() ?>/frontend/images/partners/partner2.png"></a></li>
                    <li> <a href="<?= base_url() ?>/frontend/#"><img class="img-responsive wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="900ms" src="<?= base_url() ?>/frontend/images/partners/partner3.png"></a></li>
                    <li> <a href="<?= base_url() ?>/frontend/#"><img class="img-responsive wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="1200ms" src="<?= base_url() ?>/frontend/images/partners/partner4.png"></a></li>
                    <li> <a href="<?= base_url() ?>/frontend/#"><img class="img-responsive wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="1500ms" src="<?= base_url() ?>/frontend/images/partners/partner5.png"></a></li>
                </ul>
            </div>
        </div>
        <!--/.container-->
