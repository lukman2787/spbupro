...
<div class="container-fluid mb-3 d-flex justify-content-end">
    <div class="row">
        <div class="col-12">
            <a class="btn btn-sm bg-navy" href="<?= base_url('admin/group/new') ?>">Tambah <i class="fa fa-plus"></i></a>
        </div>
    </div>
</div>
                                ...
                                <td class="text-center">
                                    <div class="btn-group">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" href="javascript:void(0)" data-id="<?= $group->id ?>" id="showBook" class="btn btn-sm bg-navy">View</a>
                                            <a class="dropdown-item" href="<?= base_url('admin/group/'. $group->id .'/edit') ?>" class="btn bg-navy btn-sm">Edit</a>
