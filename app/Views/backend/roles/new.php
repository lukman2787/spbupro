                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" class="form-control form-control-sm  <?= $validation->hasError('name') ? 'is-invalid' : '' ?>" placeholder="Masukan nama role" value="<?= old('name') ?>">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="description" class="form-control form-control-sm " placeholder="Masukan deskripsi" value="<?= old('description') ?>">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group">
